...
tf.flags.DEFINE_float("lstm_lr", 1e-1, "training learning rate")
tf.flags.DEFINE_float("rnn_tanh_lr", 1e-1, "training learning rate")
tf.flags.DEFINE_float("rnn_relu_lr", 1e-1, "training learning rate")
tf.flags.DEFINE_float("irnn_lr", 1e-1, "training learning rate")
